/*
  ...
  - The values [Pasado] on the enum `EstadoTurnos` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "EstadoTurnos_new" AS ENUM ('Iniciado', 'TiempoOfertas', 'TiempoOfertasFinalizado', 'TiempoPagosTurnos', 'TiempoPagosTurnosFinalizado', 'TiempoPagosMultas', 'TiempoPagosMultasFinalizado', 'Finalizado');
