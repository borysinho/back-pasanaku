/*
  ...
  - The values [EnviandoInvitaciones,ListoParaEmpezar] on the enum `EstadoJuego` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "EstadoJuego_new" AS ENUM ('Nuevo', 'Iniciado', 'Finalizado');
