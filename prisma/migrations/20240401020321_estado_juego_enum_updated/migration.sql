/*
  ...
  - The values [nuevo,invitacion,listoparaempezar,iniciado,finalizado] on the enum `EstadoJuego` will be removed. If these variants are still used in the database, this will fail.
