/*
  ...
  - The values [NoEnviado,Enviado] on the enum `EstadoInvitacion` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "EstadoInvitacion_new" AS ENUM ('Pendiente', 'Aceptado', 'Rechazado', 'Cancelado');
...
ALTER TABLE "Invitados_Juegos" ALTER COLUMN "estado_invitacion" SET DEFAULT 'Pendiente';
COMMIT;
