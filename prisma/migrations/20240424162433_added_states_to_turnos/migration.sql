/*
  ...
  - The values [Actual,Futuro] on the enum `EstadoTurnos` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "EstadoTurnos_new" AS ENUM ('Pasado', 'Tiempo_Ofertas', 'Tiempo_Pago');
...
ALTER TABLE "Turnos" ALTER COLUMN "estado_turno" SET DEFAULT 'Tiempo_Ofertas';
COMMIT;
